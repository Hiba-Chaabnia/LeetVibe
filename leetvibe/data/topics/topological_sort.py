...
TOPIC: dict = {
    ...
    "pattern2": (
        "# DFS-based topological sort — postorder append then reverse\n"
    ...
    "pitfalls": (
        ...
        "• Longest path DP: update dp[nei] = max(dp[nei], dp[node]+1) during\n"
        "  BFS — only correct because you process nodes in topological order."
    ),
    "time": "O(V + E)",
    "space": "O(V + E)",
    "problems": [
