...
class ChallengeListScreen(BaseScreen):
    ...
    def __init__(self, mode: str = "learn", initial_topic: str = "all") -> None:
        super().__init__()
        self._mode = mode
    ...
    def _populate_topic_filter(self) -> None:
        ...
        if self._initial_topic != "all":
            self.filter_topic = self._initial_topic
            try:
                sel.value = self._initial_topic
            except Exception:
                pass
